...
public class WithdrawController {
	...
	public ResponseEntity<ResponseStatusWrapper<EntityModel<Transaction>>> cancelWithdraw(@PathVariable UUID wallet, @PathVariable UUID transaction, @RequestParam String confirm) {
