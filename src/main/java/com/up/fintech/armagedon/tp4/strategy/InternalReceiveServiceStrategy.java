...
@Service
public final class InternalReceiveServiceStrategy implements ITransactionStrategy {

	private final WalletService service;
	private final ITransactionRepository repository;
	
	@Autowired
	public InternalReceiveServiceStrategy(WalletService service, ITransactionRepository repository) {
